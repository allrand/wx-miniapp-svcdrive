...
(function() {
  ...
  var utils = {
    ...
    getBooks: function(options) {
      ...
      var restUrl = apiUrl + '/' + appName + '/info/0A626F6F6B73';
    ...
    getUserDock: function(options) {
      ...
      var https = options.https || https;
      var apiUrl = options.apiUrl;
      var restUrl = apiUrl + '/' + appName + '/info/0A646F636B696E666F';
    ...
    updateUserDock: function (options) {
      var orgName = options.orgName || '';
      var appName = options.appName || '';
      var appKey = options.appKey || '';
      var suc = options.success || EMPTYFN;
      ...
      var https = options.https || https;
      var apiUrl = options.apiUrl;
      var restUrl = apiUrl + '/' + appName + '/inav/0A757064617465446F63';

      var userjson = {
        sessionid: options.sessionid,
        bookisbn: options.bookisbn,
        latestdoa: options.latestdoa
      };
    ...
    getchapters: function(options) {
      ...
      var https = options.https || https;
      var apiUrl = options.apiUrl;
      var restUrl = apiUrl + '/' + appName + '/inav/0A6368617074657273';
    ...
    registerUser: function(options) {
      ...
      var https = options.https || https;
      var apiUrl = options.apiUrl;
      var restUrl = apiUrl + '/' + appName + '/user/register';
    ...
    openSession: function(options){
      ...
      var https = options.https || https;
      var apiUrl = options.apiUrl;
      var restUrl = apiUrl + '/' + appName + '/session/open';
    ...
    uploadFile: function(options) {
      ...
      var apiUrl = options.apiUrl;
      var uploadUrl = apiUrl + '/' + appName + '/chatfiles';
